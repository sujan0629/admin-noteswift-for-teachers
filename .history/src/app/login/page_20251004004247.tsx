        ...
        <div className="relative z-10 max-w-md">
          <div className="mb-8 inline-flex items-center gap-3">
            <div className="p-3 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-lg">
              <Image src="/assets/logo.jpg" alt="NoteSwift Logo" width={40} height={40} className="rounded-lg" />
            </div>
            <div>
      ...
      <div className="flex flex-1 items-center justify-center p-4 lg:p-12 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center justify-center mb-8">
            <div className="p-3 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-lg">
              <Image src="/assets/logo.jpg" alt="NoteSwift Logo" width={32} height={32} className="rounded-lg" />
            </div>
          </div>

          <Card className="backdrop-blur-sm bg-white/80 shadow-2xl border-2 border-white/50">
        <CardHeader className="text-center space-y-2">
          <div className="inline-flex items-center gap-2 mx-auto mb-2 rounded-full bg-gradient-to-r from-blue-600 to-blue-700 px-4 py-1.5 text-white text-xs font-medium shadow-md">
        ...
        <CardContent className="p-6">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <Button 
              type="submit" 
              className="w-full font-semibold text-base h-12 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 shadow-lg hover:shadow-xl transition-all duration-200" 
              disabled={isLoading}
            >
