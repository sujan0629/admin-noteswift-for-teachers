        ...
        <CardHeader className="text-center space-y-3">
          ...
          <div className="mx-auto mb-2 relative">
            <div className="inline-flex items-center justify-center">
              <Image src="/assets/logo.png" alt="NoteSwift Logo" width={64} height={64} className="rounded-lg" />
            </div>
            <div className="absolute -right-2 -bottom-1 w-4 h-4 bg-white rounded-full flex items-center justify-center shadow-md border border-gray-100">
