...
import { BookMarked, Loader2, ShieldCheck, Mail, Clock, ArrowLeft } from "lucide-react";
  ...
  return (
    <main className="relative flex min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
        ...
        <div className="absolute -bottom-8 left-1/3 w-72 h-72 bg-teal-200/30 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center p-4 relative z-10">
        ...
        <CardHeader className="text-center space-y-3">
          ...
          <div className="inline-flex items-center gap-2 mx-auto rounded-full bg-gradient-to-r from-emerald-600 to-teal-600 px-4 py-1.5 text-white text-xs font-medium shadow-md">
