      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <div className="text-center">
            <h1 className="text-xl font-semibold text-gray-800 mb-1">Teacher's Portal</h1>
            <p className="text-sm text-gray-500">Sign in to access your NoteSwift teaching dashboard</p>
          </div>
        </div>
        ...
        <CardHeader className="text-center space-y-3 pb-2">
          ...
          <CardDescription className="text-sm text-gray-500">
            The fastest, simplest, and most secure way to manage your teaching portal
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-11 border-gray-300 focus:border-gray-400 focus:ring-1 focus:ring-gray-400 transition-all"
              />
            </div>
            <div className="space-y-2 relative">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-11 pr-10 border-gray-300 focus:border-gray-400 focus:ring-1 focus:ring-gray-400 transition-all"
                />
                <button
                  type="button"
            ...
            <Button 
              type="submit" 
              className="w-full font-semibold text-base h-12 bg-gray-900 hover:bg-gray-800 text-white shadow-md hover:shadow-lg transition-all duration-200" 
              disabled={isLoading}
            >
