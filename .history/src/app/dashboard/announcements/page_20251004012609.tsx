  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white shadow-lg relative overflow-hidden">
          <CardHeader className="pb-2">
        ...
        <Card className="bg-blue-50/60 border-2 border-blue-200 shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="pb-2">
