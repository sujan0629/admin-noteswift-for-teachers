  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-gradient-to-br from-green-500 to-emerald-600 text-white shadow-lg relative overflow-hidden">
          <CardHeader className="pb-2">
          ...
          <CardContent>
            ...
            <Send className="h-16 w-16 opacity-10 absolute -right-4 -bottom-4" />
          </CardContent>
        </Card>
        <Card className="bg-purple-50/60 border-2 border-purple-200 shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="pb-2">
        ...
        <Card className="border-t-4 border-orange-500 shadow-md hover:shadow-lg transition-all">
          <CardHeader className="pb-2">
