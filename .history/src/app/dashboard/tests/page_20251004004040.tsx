  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <Card className="border-t-4 border-blue-500 shadow-md hover:shadow-lg transition-all">
        ...
        <Card className="bg-gradient-to-br from-orange-50 via-amber-50 to-orange-50 border-orange-200">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-orange-900">Active Tests</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-xs text-orange-600/70 mt-1">Currently running</p>
          </CardContent>
        </Card>
        <Card className="bg-green-50/60 border-green-200 shadow-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-green-600/70 mt-1">Graded & analyzed</p>
          </CardContent>
        </Card>
        <Card className="border-l-4 border-purple-500 hover:border-purple-600 transition-colors">
          <CardHeader className="pb-2">
