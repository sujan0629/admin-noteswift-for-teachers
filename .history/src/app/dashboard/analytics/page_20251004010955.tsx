      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <Card className="bg-gradient-to-br from-blue-50/60 to-transparent">
          ...
          <CardContent>
            ...
            <p className="text-xs mt-1">Average</p>
          </CardContent>
        </Card>
        <Card className="border-l-4 border-blue-500 shadow-sm">
          <CardHeader className="pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs mt-1">Total entries</p>
          </CardContent>
        </Card>
      </div>
            ...
            <div className="space-y-3">
              {topPerformers.map((student) => (
                <div key={student.rank} className="flex items-center gap-3">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 text-yellow-700 font-bold text-sm">
                    {student.rank}
                  </div>
