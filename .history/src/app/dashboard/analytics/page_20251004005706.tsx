    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <Card className="bg-blue-50/60 border-blue-200">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-blue-900">Assignments</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-blue-600 flex items-center gap-2">
            ...
            <p className="text-xs text-blue-600/70 mt-1">Created</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-blue-900">Attendance</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-blue-600 flex items-center gap-2">
        ...
        <Card className="border-2 border-blue-300 bg-blue-50/50">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-blue-900">Records</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-blue-600 flex items-center gap-2">
            ...
            <p className="text-xs text-blue-600/70 mt-1">Total entries</p>
          </CardContent>
        </Card>
      </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="p-4 bg-blue-50 rounded-lg">
                      ...
                      <p className="text-3xl font-bold text-blue-600">{attendanceByDay.reduce((max, day) => day.percentage > max.percentage ? day : max).day}</p>
                    </div>
                    <div className="p-4 bg-blue-50 rounded-lg">
                      <p className="text-sm text-muted-foreground mb-1">Total Student-Days</p>
                      <p className="text-3xl font-bold text-blue-600">{attendanceByDay.reduce((sum, day) => sum + day.count, 0)}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
