  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
        <Card className="bg-gradient-to-br from-blue-500 to-cyan-600 text-white shadow-lg relative overflow-hidden">
        ...
        <Card className="bg-purple-50/60 border-purple-200">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-purple-900">Assignments</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-xs text-purple-600/70 mt-1">Created</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-indigo-50 to-blue-50 border-indigo-200">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-indigo-900">Attendance</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-xs text-indigo-600/70 mt-1">Average</p>
          </CardContent>
        </Card>
        <Card className="border-2 border-pink-300 bg-pink-50/50">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-pink-900">Records</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-xs text-pink-600/70 mt-1">Total entries</p>
          </CardContent>
        </Card>
      </div>
