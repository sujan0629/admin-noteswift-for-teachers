      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-blue-500 to-cyan-600 text-white shadow-lg relative overflow-hidden">
          ...
          <CardContent>
            ...
            <Users className="h-16 w-16 opacity-10 absolute -right-4 -bottom-4" />
          </CardContent>
        </Card>
        <Card className="border-2 border-green-300 bg-green-50/50 shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="pb-2">
        ...
        <Card className="border-l-4 border-purple-500 hover:border-purple-600 transition-colors shadow-sm">
          <CardHeader className="pb-2">
            ...
            <div className="space-y-3">
              {topPerformers.map((student: any, index: number) => (
                <div key={student._id} className="flex items-center gap-3">
                  ...
                  <Badge className="bg-green-500">{student.averageScore}%</Badge>
                </div>
              ))}
            </div>
          </CardContent>
                  ...
                  <Card key={student._id}>
                    <CardHeader className="pb-3">
                      <div className="flex justify-between items-start">
                        ...
                        <Badge className={student.overallProgress >= 80 ? 'bg-green-500' : student.overallProgress >= 60 ? 'bg-yellow-500' : 'bg-red-500'}>
