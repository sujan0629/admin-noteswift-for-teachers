      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-blue-50 to-blue-100/50 border-blue-200 shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-blue-900">Classes This Month</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-xs text-blue-600/70 mt-1">+3 from last month</p>
          </CardContent>
        </Card>
        <Card className="border-l-4 border-green-500 hover:border-green-600 transition-colors shadow-sm">
          <CardHeader className="pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Strong participation</p>
          </CardContent>
        </Card>
        <Card className="bg-blue-50/60 border-blue-100 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-blue-900">Recording Views</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold text-blue-600 flex items-center gap-2">
            ...
            <p className="text-xs text-blue-600/70 mt-1">Students catching up</p>
          </CardContent>
        </Card>
        <Card className="border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-white shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-blue-900">Total Live Hours</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold text-blue-600 flex items-center gap-2">
            ...
            <p className="text-xs text-blue-600/70 mt-1">This month</p>
          </CardContent>
        </Card>
      </div>
