...
async function getData() {
  ...
  return {
    upcomingClasses: [
      { 
        _id: '1', 
        subject: 'Grade 11 Mathematics - Calculus', 
      ...
      { 
        _id: '2', 
        subject: 'Grade 11 Mathematics - Trigonometry', 
        course: 'Grade 11 Study Package',
    ...
    pastClasses: [
      { 
        _id: '4', 
        subject: 'Grade 11 Mathematics - Algebra', 
        course: 'Grade 11 Study Package',
        scheduledAt: new Date(now - 86400000).toISOString(), 
        durationMinutes: 60, 
        platform: 'zoom',
      ...
      { 
        _id: '5', 
        subject: 'Grade 11 Mathematics - Coordinate Geometry', 
        course: 'Grade 11 Study Package',
    ...
    stats: {
      ...
      totalRecordingViews: 5,
      totalLiveHours: 6
    },
    courses: [
      { _id: '1', title: 'Grade 11 Study Package', subject: 'Mathematics' }
    ],
    chapters: [
...
export default async function LiveClassesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold">Live Classes Management</h1>
