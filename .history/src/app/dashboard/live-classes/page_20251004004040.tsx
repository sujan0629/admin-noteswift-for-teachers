    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-purple-50/60 border-purple-100 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-purple-900">Recording Views</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-xs text-purple-600/70 mt-1">Students catching up</p>
          </CardContent>
        </Card>
        <Card className="border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-white shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-orange-900">Total Live Hours</CardTitle>
          </CardHeader>
          <CardContent>
