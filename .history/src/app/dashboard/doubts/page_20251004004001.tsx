  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 border-indigo-200 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Total Doubts</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold flex items-center gap-2 text-indigo-600">
        ...
        <Card className="border-2 border-orange-300 bg-orange-50/50 shadow-md hover:shadow-lg transition-all">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Open Doubts</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-lg relative overflow-hidden">
          <CardHeader className="pb-2">
          ...
          <CardContent>
            ...
            <Clock className="h-16 w-16 opacity-10 absolute -right-4 -bottom-4" />
          </CardContent>
        </Card>
      </div>
                  ...
                  <CardContent>
                    <div className="space-y-3 mb-4">
                      {doubt.messages.map((message: any, idx: number) => (
                        <div 
                          key={idx} 
                          className={`p-3 rounded-lg ${message.senderType === 'student' ? 'bg-blue-50' : 'bg-green-50'}`}
                        >
                          <div className="flex items-center gap-2 mb-1">
                  ...
                  <CardContent>
                    <div className="space-y-2 mb-4">
                      {doubt.messages.map((message: any, idx: number) => (
                        <div 
                          key={idx} 
                          className={`p-2 rounded text-sm ${message.senderType === 'student' ? 'bg-blue-50' : 'bg-green-50'}`}
                        >
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-xl font-bold text-green-600">{article.helpfulVotes}</p>
                        </div>
                      </div>
                      <Progress 
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-lg font-bold text-green-600">{resolvedDoubts.length}</span>
                      </div>
                      <Progress 
