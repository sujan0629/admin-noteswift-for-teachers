  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-blue-50 via-blue-50 to-blue-100 border-blue-200 shadow-sm">
        ...
        <Card className="border-2 border-blue-300 bg-blue-50/50 shadow-md hover:shadow-lg transition-all">
          <CardHeader className="pb-2">
