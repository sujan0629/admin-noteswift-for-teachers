...
async function getData() {
  ...
  return {
    assignments: [
      { _id: 'a1', title: 'Algebra Problem Set 1', description: 'Solve equations 1-20', deadline: new Date(Date.now() + 86400000).toISOString() },
      { _id: 'a2', title: 'Physics Lab Report', description: 'Write report on pendulum experiment', deadline: new Date(Date.now() + 172800000).toISOString() }
    ],
    courses: [
    ...
    submissions: [
      { _id: 'sub1', assignment: 'a1', student: { name: 'John Doe' }, submittedAt: new Date().toISOString(), score: 85, feedback: 'Good work!' },
      { _id: 'sub2', assignment: 'a1', student: { name: 'Jane Smith' }, submittedAt: new Date().toISOString(), score: 0, feedback: '' }
    ]
  };
}
