  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Welcome back! Here's what's happening with your classes today.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-l-4 border-blue-500">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Students need help</p>
          </CardContent>
        </Card>
            ...
            <div className="space-y-3">
              {upcoming.map((cls:any)=> (
                <div key={cls._id} className="group flex items-center justify-between border rounded-lg p-4 hover:bg-blue-500 hover:border-blue-600 transition-all cursor-pointer">
                  ...
                  <Button size="sm" className="group-hover:bg-white group-hover:text-blue-600 group-hover:hover:bg-white/90 transition-colors">Join Now</Button>
                </div>
              ))}
